...
export async function generateMetadata({
  ...
  return {
    title: t("lebanon.pageTitle"),
    description: t("lebanon.pageSubtitle"),
  };
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-spotDark mb-2">{t("lebanon.pageTitle")}</h1>
          <p className="text-sm sm:text-base text-gray-600">
            {t("lebanon.pageSubtitle")}
          </p>
        </div>
        ...
        {properties.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">{t("lebanon.noProperties")}</p>
            <Link
              href="/properties"
